...
omega1 = gcurve(graph = oscillation, color=color.yellow, width=4)
omega2 = gcurve(graph = oscillation, color=color.blue, width=4)
omega3 = gcurve(graph = oscillation, color=color.red, width=4)
